...
import { useAttachmentsByResource } from "~/hooks";
...
export default function AttachmentsTab() {
  ...
  const { attachments, isLoading, error } = useAttachmentsByResource(resourceId, {
      ...
      {error ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">
            {filter !== "all" ? `No ${filter} attachments found` : "No attachments extracted yet."}
          </p>
          {filter !== "all" && (
