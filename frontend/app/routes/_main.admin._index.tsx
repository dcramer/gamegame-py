    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your games and resources</p>
        </div>
        <Button asChild>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {isLoading ? (
                ...
                games.reduce((sum, g) => sum + (g.resource_count ?? 0), 0)
              )}
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {isLoading ? (
                ...
                games.filter((g) => (g.resource_count ?? 0) > 0).length
              )}
            </div>
          </CardContent>
        </Card>
                    ...
                    <TableCell>
                      {(game.resource_count ?? 0) > 0 ? (
                        <Badge variant="secondary">
                          {game.resource_count}{" "}
                          {game.resource_count === 1 ? "resource" : "resources"}
                        </Badge>
                      ) : (
